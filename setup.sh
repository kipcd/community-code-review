...
echo ""
echo "  Share this with volunteers:"
echo ""
echo "    📖 Volunteer setup guide:"
echo "       https://github.com/got-feedback/community-code-review/blob/main/docs/VOLUNTEER_SETUP.md"
echo ""
echo "    🔗 Coordinator URL:  ${FUNNEL_URL}"
echo "    🔑 Volunteer secret: ${COORDINATOR_SECRET}"
echo ""
